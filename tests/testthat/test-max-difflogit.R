...
test_that("Estimating logit parameters", {
    ...
    result <- FitMaxDiff(design = tech.design, version = rep(1, nrow(best)),
                         ...
                         is.tricked = FALSE)
    q.solution <- c(0, -0.09059317085259,-1.022392901667,0.3712129560247,
                    -0.6596444467744,0.02930605087281,-0.08321462352542,
                    -0.870332546743,-1.105990654593,-0.8674738151854)
    ...
    q.solution <- c(0,-0.09164874531048,-1.416097197804,0.5413188029853,
                    -0.8428037706912,-0.5743677293267,-0.4820668863369,
                    -0.8572557181654,-1.530467590026,-1.143659145101)
    expect_equal(as.vector(result$coef), q.solution, tolerance = 0.0001)
    # Subset and weight
    ...
    result <- FitMaxDiff(design = tech.design, version = rep(1, nrow(best)),
                         ...
                         is.tricked = FALSE)
    q.solution <- c(0,-0.1358158415588,-1.310226780669,0.4291539729508,
                    -0.7617988208062,-0.5332417439411,-0.4662730731195,
                    -0.8116530486171,-1.356435800804,-1.148628546175)
...
test_that("Latent class", {
    ...
    q.solution <- structure(c(0, -2.30575675367483, -3.4390021812939,
                              -1.718556454195, -3.03608376429065,
                              -2.43609639597502, -2.42392249235851,
                              -3.28327816635577, -3.50897927456835,
                              -3.44485235322318, 0, 1.38580057447584,
                              0.428462438590491, 1.84870129481078,
                              0.931693897342025, 1.97524268771123,
                              1.63144214440238, 0.701477372305963,
                              0.327266346090314, 0.941038167774774),
                            .Dim = c(10L, 2L))
    ...
    q.solution <- structure(c(0, -1.34109808073123, -3.72839178922714,
                              -0.524605012308453,-2.73912325516393,
                              -1.41606753418318, -2.45802001427938,
                              -3.18998838616667, -3.78237027293449,
                              -3.3674225091177, 0, 0.517444911638947,
                              0.275768946657516,1.04463763172229,
                              0.425653550385925, -0.0960750355595251,
                              0.904803630723954, 0.858383432709159,
                              0.19099885898787, 0.164046805635207),
                            .Dim = c(10L, 2L))
